    ...
    <div class="w-80 bg-white border-r border-gray-200 flex flex-col fixed h-full z-10">
      ...
      <div class="flex-1 overflow-y-auto px-4 pb-4">
       ...
       <div class="p-4 border-t border-gray-100">
        <button @click="logout" class="w-full text-gray-500 hover:text-red-600 hover:bg-red-50 px-4 py-2 rounded-lg transition-colors flex items-center justify-center space-x-2">
